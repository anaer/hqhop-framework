...
import com.hqhop.framework.common.orm.search.filter.SearchFilterHelper;
import com.hqhop.framework.common.orm.search.utils.SearchableConvertUtils;
...
public final class SearchRequest extends Searchable {
	 ...
	 * @param searchParams
	 * @see 
	 *      SearchRequest#SearchRequest(java.util.Map<java.lang.String,java.lang.
	 *      Object>)
	 */
	 ...
	 *            排序
	 */
	public SearchRequest(final Map<String, Object> searchParams, final Pageable page, final Sort sort) throws SearchException {
