package com.hqhop.framework.common.orm.hibernate;
...
import com.hqhop.framework.common.orm.BaseRepository;
import com.hqhop.framework.common.orm.RepositoryHelper;
import com.hqhop.framework.common.orm.search.Searchable;
import com.hqhop.framework.common.orm.sql.SQL;
import com.hqhop.framework.common.orm.sql.SQLContext;
...
public class BaseRepoitoryImpl<T extends AbstractEntity<ID>, ID extends Serializable> implements BaseRepository<T, ID> {
	...
	for (Class inter : inters) {
	    if ("LogicDeleteable".equals(inter.getSimpleName())) {
		flag = true;
		break;
	    }
	}
