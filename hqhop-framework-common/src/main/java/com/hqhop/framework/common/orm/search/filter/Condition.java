...
import com.hqhop.framework.common.orm.search.exception.InvlidSearchOperatorException;
...
public final class Condition implements SearchFilter {
	...
	static Condition newCondition(final String key, final Object value) throws SearchException {
		...
		isValueBlank = isValueBlank || (value instanceof String && Utils.isEmpty((String) value));
	...
	public boolean isUnaryFilter() {
		...
		return Utils.isNotEmpty(operatorStr) && operatorStr.startsWith("is");
	}
	...
	public String toString() {
		return "Condition{" + "searchProperty='" + searchProperty + '\'' + ", operator=" + operator + ", value=" + value + '}';
	}
}
